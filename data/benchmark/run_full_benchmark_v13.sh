#!/usr/bin/env bash
# End-to-end ClinVar 2-star+ benchmark (v13).
#
# Inputs:
...
#
# Outputs:
#   - data/benchmark/output_v13/clinvar_2star.fastvep.vcf.gz   (annotation + ACMG, bgzipped)
#   - data/benchmark/output_v13/concordance_summary.txt
#   - data/benchmark/output_v13/concordance_matrix.csv
#   - data/benchmark/output_v13/concordance_by_chrom.csv
#   - data/benchmark/output_v13/concordance_by_consequence.csv
#   - data/benchmark/output_v13/criterion_firing_rates.csv
#   - data/benchmark/output_v13/discrepancies.tsv
#
...
OUT_DIR=$ROOT/data/benchmark/output_v13
mkdir -p "$OUT_DIR"
