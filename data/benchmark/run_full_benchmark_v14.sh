#!/usr/bin/env bash
# End-to-end ClinVar 2-star+ benchmark (v14).
#
# Inputs:
...
#
# Outputs:
#   - data/benchmark/output_v14/clinvar_2star.fastvep.vcf.gz   (annotation + ACMG, bgzipped)
#   - data/benchmark/output_v14/concordance_summary.txt
#   - data/benchmark/output_v14/concordance_matrix.csv
#   - data/benchmark/output_v14/concordance_by_chrom.csv
#   - data/benchmark/output_v14/concordance_by_consequence.csv
#   - data/benchmark/output_v14/criterion_firing_rates.csv
#   - data/benchmark/output_v14/discrepancies.tsv
#
...
OUT_DIR=$ROOT/data/benchmark/output_v14
mkdir -p "$OUT_DIR"
