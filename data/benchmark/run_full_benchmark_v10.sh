...
#
# Outputs:
#   - data/benchmark/output_v10/clinvar_2star.fastvep.vcf.gz   (annotation + ACMG, bgzipped)
#   - data/benchmark/output_v10/concordance_summary.txt
#   - data/benchmark/output_v10/concordance_matrix.csv
#   - data/benchmark/output_v10/concordance_by_chrom.csv
#   - data/benchmark/output_v10/concordance_by_consequence.csv
#   - data/benchmark/output_v10/criterion_firing_rates.csv
#   - data/benchmark/output_v10/discrepancies.tsv
#
...
OUT_DIR=$ROOT/data/benchmark/output_v10
mkdir -p "$OUT_DIR"
