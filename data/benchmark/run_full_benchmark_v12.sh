...
#
# Outputs:
#   - data/benchmark/output_v12/clinvar_2star.fastvep.vcf.gz   (annotation + ACMG, bgzipped)
#   - data/benchmark/output_v12/concordance_summary.txt
#   - data/benchmark/output_v12/concordance_matrix.csv
#   - data/benchmark/output_v12/concordance_by_chrom.csv
#   - data/benchmark/output_v12/concordance_by_consequence.csv
#   - data/benchmark/output_v12/criterion_firing_rates.csv
#   - data/benchmark/output_v12/discrepancies.tsv
#
...
OUT_DIR=$ROOT/data/benchmark/output_v12
mkdir -p "$OUT_DIR"
